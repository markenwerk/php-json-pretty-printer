# Contributing to PHP JSON Pretty Printer
...
Here’s an example workflow for `php-json-pretty-printer` hosted on Github, which is currently in version 1.0.2. Your username is `yourname` and you’re submitting a basic bugfix. 

### Preparing your Fork

- Hit ‘fork’ on Github, creating e.g. `yourname/php-json-pretty-printer`
- Clone your project  

```
git clone git@github.com:yourname/php-json-pretty-printer
```

- Create a branch

```
cd php-json-pretty-printer
